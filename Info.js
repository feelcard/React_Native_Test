...
class Info extends Component {
  ...
  render() {
    const { id, propVisible } = this.props;

    const data = this.state.dataList.filter(
      (data) => data.id == id);
        ...
        <View style={styles.overlayInnerWrap}>
          <View style={styles.innerBox}>
            ...
            <View style={styles.description}>
              ...
              <Text></Text>
              <Image
                style={data[0].imgStyle}
                source={data[0].imgSrc}
              />
              <Text></Text>
              <Text style={{ fontFamily: "NanumGothic-Regular", fontSize: 13 }}>
                {data[0].description}
              </Text>
            </View>
          </View>
